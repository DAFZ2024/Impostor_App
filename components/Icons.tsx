...
export function AlienIcon({ size = 24, color = '#e74c3c' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 64 64" fill="none">
      {/* Antenas */}
      <Line x1="22" y1="10" x2="18" y2="2" stroke={color} strokeWidth={2} strokeLinecap="round" />
      <Circle cx="18" cy="2" r="2" fill={color} />
      <Line x1="42" y1="10" x2="46" y2="2" stroke={color} strokeWidth={2} strokeLinecap="round" />
      ...
      {/* Boca */}
      <Path d="M28 44 Q32 48 36 44" stroke={color} strokeWidth={2} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
